-- This query will be executed by DuckDB and written to gold/data/entity_membership.parquet
...
WITH complex_members AS (
    ...
    JOIN read_parquet('gold/data/entity.parquet') AS ge_parent ON e.canonical_identifier = ge_parent.canonical_identifier
...
memberships AS (
    ...
    JOIN read_parquet('gold/data/entity.parquet') AS ge_member ON cm.member_id = ge_member.canonical_identifier
