...
3. Copies the dump file from the Docker volume to a local directory
"""
...
def find_meilisearch_container() -> str:
    ...
    if not containers or containers[0] == '':
        raise RuntimeError("No Meilisearch container found. Is docker compose running?")
