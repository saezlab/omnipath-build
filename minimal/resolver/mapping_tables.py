...
from minimal.resolver.paths import activate_raw_download_data_dir, ensure_data_dir
from minimal.resolver.sources import CHEMICAL_SOURCES, materialize_chemical_sources, materialize_proteins
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description='Materialize minimal resolver lookup tables.'
    )
    parser.add_argument(
        'sources',
        nargs='+',
