...
def _load_protein_sources(
    ...
    *,
    ...
    from minimal.resolver.sources.proteins import _protein_identifier_rows
...
def _load_chemical_sources(
    ...
    *,
    ...
    from minimal.resolver.sources.chemicals import _chemical_identifier_rows
...
def _normalized_protein_rows(rows: object) -> object:
    from minimal.resolver.identifier_types import identifier_type_id
    from minimal.resolver.sources.proteins import UNIPROT_TYPE
...
def _normalized_chemical_rows(rows: object) -> object:
    from minimal.resolver.identifier_types import identifier_type_id
    from minimal.resolver.sources.chemicals import STANDARD_INCHI_KEY_TYPE
